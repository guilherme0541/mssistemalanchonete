...
@Repository
public class ProdutoRepositoryRepository implements ProdutoRepositoryPort {

    private final IProdutoRepository iProdutoRepository;
    private final ProdutoMapper produtoMapper;

    @Autowired
    public ProdutoRepositoryRepository(IProdutoRepository iProdutoRepository, ProdutoMapper produtoMapper){
